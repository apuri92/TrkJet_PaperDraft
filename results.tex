...
%\centerline{
%         \begin{tabular}{cc}
%            \includegraphics[width=0.5\textwidth]{figures/results/ChPS_dR_DpT_jet7_cent0.pdf} & 
%            \includegraphics[width=0.5\textwidth]{figures/results/ChPS_dR_DpT_jet7_cent5.pdf} \\
%            \includegraphics[width=0.5\textwidth]{figures/results/ChPS_dR_DpT_jet9_cent0.pdf} & 
%            \includegraphics[width=0.5\textwidth]{figures/results/ChPS_dR_DpT_jet9_cent5.pdf} \\
%      \end{tabular}
%      }
...
%This observation is also in agreement with the previous measurement of jet fragmentation functions \cite{Chatrchyan:2014ava, Sirunyan:2018jqr, Aaboud:2017bzv, PhysRevC.98.024908} 

\begin{figure}
\centering{
\begin{tabular}{cc}
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet7_cent0} &
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet9_cent0} \\
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet7_cent3} &
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet9_cent3} \\
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet7_cent5} &
	 \includegraphics[width=0.45\textwidth]{results/RDpT_trkpt_jet9_cent5} \\
\end{tabular} }
