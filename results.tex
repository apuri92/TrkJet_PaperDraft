...
For these particles, the enhancement of yields in Pb+Pb compared to pp collisions grows with increasing \rvar\ up to \mbox{$\rvar  = 0.3$}.
 It is approximately constant for \rvar in the interval \mbox{0.3 -- 0.6} and decreases for \mbox{$\rvar > 0.6$}.  For charged particles with $\pt > 4.0$ \GeV, \RDptr\ shows a depletion outside the jet core for $r > 0.05$. The magnitude of this depletion increases with increasing \rvar\ up to $r = 0.3$ and is approximately constant thereafter.
