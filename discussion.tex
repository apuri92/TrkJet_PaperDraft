...
\centering{
\begin{tabular}{ccc}
	 \includegraphics[width=0.3\textwidth]{results/DeltaDpT_lowpt_integ_cent0.pdf} &
   %	 \includegraphics[width=0.5\textwidth]{results/DeltaDpT_jetshape_cent0.pdf} \\
	 \includegraphics[width=0.3\textwidth]{results/DeltaDpT_lowpt_integ_cent3.pdf} &
%	 \includegraphics[width=0.5\textwidth]{results/DeltaDpT_jetshape_cent3.pdf} \\
	 \includegraphics[width=0.3\textwidth]{results/DeltaDpT_lowpt_integ_cent5.pdf} \\
