...
No significant \ptjet\ dependence is seen at larger \rvar\ values.
Furthermore, the \RDptr\ distributions for high-\pt\ charged particles do not seem to show any significant \ptjet\ dependence at any \rvar.
...
In order to remove that dependence, Section~\ref{sec:discussion_int} provides similar quantities in which a wider charged-particle \pt\ range is integrated over.
