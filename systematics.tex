...
%The default method is limited by the finite statistics of the minimum bias data collected and the cone method is sensitive to hard scattering induced biases in the UE. The UE estimate from the default method requires centrality reweighing, whereas the estimate from the cone method matches the centrality distribution of the jet sample by construction.
...
\includegraphics[width=0.55\textwidth]{figures/systematics/RDpT_dR_sys_error_trk6_jet7_cent0} \\
\includegraphics[width=0.55\textwidth]{figures/systematics/RDpT_dR_sys_error_trk2_jet7_cent5} &
\includegraphics[width=0.55\textwidth]{figures/systematics/RDpT_dR_sys_error_trk6_jet7_cent5} \\
\end{tabular}}
\caption{
